import{s,v as f,w as R,x as B}from"./theme.CYRSML_O.js";import{d as X,p as d,v as S,$,o as z,c as V,j as t,N as i}from"./framework.uyLDs8jX.js";const N={absolute:"",inset:"0",flex:"",items:"center"},P=X({name:"ColorPickerAlpha",__name:"color-picker-alpha",props:{defaultValue:{type:Number,default:1},selectedColor:{type:String,default:"#ff0000"}},emits:["change"],setup(a,{emit:k}){const p=a,h=k,c=d(),m=d(),y=d();let n=null,r=!1,v=0,u=0;const l=d(0);function g(o){o.stopPropagation(),r=!0,v=o.clientX,l.value=o.clientX-n.left,u=l.value,h("change",1-l.value/n.width),s(document.body,"mousemove",C)}function x(o){if(!r)return;r=!0;let e=o.clientX-v+u;e<0?e=0:e>n.width&&(e=n.width),l.value=e,h("change",1-l.value/n.width)}const C=R(x,18);function A(){r=!1,u=l.value,f(document.body,"mousemove",C)}function w(){n=m.value.getBoundingClientRect()}const b=B(w,300);return S(()=>{w(),p.defaultValue&&(l.value=n.width*(1-p.defaultValue),u=l.value),s(c.value,"mousedown",g),s(document.body,"mouseup",A),s(window,"resize",b)}),$(()=>{f(c.value,"mousedown",g),f(window,"resize",b)}),(o,e)=>(z(),V("div",{ref_key:"ColorAlphaRef",ref:c,relative:"",w:"full",h:"2.5",select:"none"},[e[2]||(e[2]=t("div",{absolute:"",inset:"0",w:"full",h:"full",rounded:"full",overflow:"hidden",style:{background:"#ffffff66","background-image":`linear-gradient(
            45deg,
            #c5c5c5 25%,
            transparent 0,
            transparent 75%,
